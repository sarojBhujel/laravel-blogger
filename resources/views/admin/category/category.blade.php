      ...
      <div class="container-fluid">
        <div class="card">
            <div class="card-header">
              ...
              <a href="{{route('category.create')}}" class="btn btn-info offset-md-4" >Add new</a>
            </div>
            <div class="card-body">
                  ...
                  <tbody>
                    @foreach ($category as $k)
                        <tr>
                          ...
                          <td>{{$k->slug}}</td>
                          <td>
                            <a href="{{route('category.edit',$k->id)}}"><i class="fas fa-edit"></i></a>
                          </td>
                          <td>
                            <form action="{{route('category.destroy',$k->id)}}" method="post" id="delete-form-{{$k->id}}">
                              @csrf
                              @method('delete')
                            </form>
                            <a href="{{route('category.destroy',$k->id)}}" onclick="
