      ...
      <section class="content">
        <div class="container-fluid">
          <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{route('menu.update',$edit->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" name="title" id="" class="form-control" value="{{$edit->title}}">
                    </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input name="oldImage" type="hidden" class="form-control" value="{{$edit->image}}">
                      <img class="img-fluid" src="{{asset('img/'.$edit->image)}}"/>
                    </div>
                        <div class="card card-outline card-info">
                          <div class="card-header">
                            <h3 class="card-title">
                              Give small intro about yourself
                            </h3>
                            <!-- tools box -->
                          ...
                          <div class="card-body pad">
                            <div class="mb-3">
                              <textarea class="textarea" placeholder="Place some text here"
                                        style="width: 100%; height: 500px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" id="editor" name="intro">
                                        {!!$edit->intro!!}
                                      </textarea>
                            </div>
                          </div>
